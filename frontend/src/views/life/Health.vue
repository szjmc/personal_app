          ...
          >
            ...
            <div class="habit-check">
              <el-checkbox
                ...
                @change="(checked) => handleCheckIn(habit, checked)"
                size="large"
              />
            </div>
            ...
            <div class="habit-streak">
              ...
              <span>{{ habit.streak_days || 0 }}天</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="habits-list">
          ...
          >
            ...
            <div class="habit-stats-mini">
              ...
              <div class="stat-item">
                <div class="stat-value">{{ habit.streak_days || 0 }}</div>
                <div class="stat-label">连续天数</div>
              </div>
            </div>
            
            <div class="habit-actions">
              <el-dropdown @command="(cmd) => handleHabitAction(cmd, habit)" trigger="click">
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    ...
                    >
                      <el-icon>{{ habit.is_active ? <VideoPause /> : <VideoPlay /> }}</el-icon>
...
import {
  Plus, Calendar, ArrowLeft, ArrowRight, Fire,
  MoreFilled, Edit, DataAnalysis, VideoPause, VideoPlay, Delete,
  Sunny, Moon, Apple, Coffee, Water, BookOpen, Trophy, 
  Heart, Footprint, Medicine
...
// 图标列表
const habitIcons = [
  'Heart', 'Sunny', 'Moon', 'Apple', 'Coffee', 'Water', 
  'BookOpen', 'Trophy', 'Footprint', 'Medicine'
]
